...
export class UsuariosService {
  ...
  list(params?: any): Observable<User[]> {
    ...
    .pipe(
      ...
      catchError(this.handleError('UsuariosService.list', []))
    );
  }
  ...
  get(id: string, params?: any): Observable<User> {
    ...
    .pipe(
      ...
      catchError(this.handleError<User>(`UsuariosService.get id=${id}`))
    );
  }
